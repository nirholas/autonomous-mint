...
Design a bounded agent policy for issuing collectibles without surrendering owner control.

## Why this exists

Solana transaction v1 raises the maximum transaction size from 1,232 to 4,096 bytes. Autonomous Mint explores a focused consumer use of that space while making the wire budget visible.
